...
namespace demoabpapp.blazorservertiered.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("blazorservertiered") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "blazorservertiered", DisplayName = "blazorservertiered API", Resources = { "blazorservertiered" }
            });
        }
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        var blazorServerTieredClientId = configurationSection["blazorservertiered_BlazorServerTiered:ClientId"];
        if (!blazorServerTieredClientId.IsNullOrWhiteSpace())
        {
            var blazorServerTieredRootUrl = configurationSection["blazorservertiered_BlazorServerTiered:RootUrl"]!.EnsureEndsWith('/');
            ...
            await CreateApplicationAsync(
                ...
                secret: configurationSection["blazorservertiered_BlazorServerTiered:ClientSecret"] ?? "1q2w3e*",
        ...
        // Swagger Client
        var swaggerClientId = configurationSection["blazorservertiered_Swagger:ClientId"];
        if (!swaggerClientId.IsNullOrWhiteSpace())
        {
            var swaggerRootUrl = configurationSection["blazorservertiered_Swagger:RootUrl"]?.TrimEnd('/');
