...
public class blazorservertieredDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public blazorservertieredDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
